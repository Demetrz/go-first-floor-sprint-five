...
func (t Training) distance() float64 {
	// вставьте ваш код ниже
		return Distance = Action*LenStep/MInKm
}

// meanSpeed возвращает среднюю скорость бега или ходьбы.
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
		return Speed = distance/float64(t.Duration)
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier * Speed + CaloriesMeanSpeedShift) * Weight / MInKm * MinInHours)
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return r.TrainingInfo().TrainingType
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier * Weight + (Speed**2 / Height) * CaloriesSpeedHeightMultiplier * Weight) * Duration.Hours * MinInHours)
}
