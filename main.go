...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infRun := r.Training.TrainingInfo()
	infRun.Speed = r.meanSpeed()
	infRun.Distance = infRun.Speed * r.Duration.Hours()
	return infRun
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	Speed := w.meanSpeed()
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(Speed*KmHInMsec, 2)/(w.Height*CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infWalk := w.Training.TrainingInfo()
	infWalk.Speed = w.meanSpeed()
	infWalk.Distance = infWalk.Speed * w.Duration.Hours()
	return infWalk
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infSwim := s.Training.TrainingInfo()
	infSwim.Speed = s.meanSpeed()
	infSwim.Distance = infSwim.Speed * s.Duration.Hours()
	return infSwim
}
